...
class Pathology(BaseModel):
    ...
    working_days = ArrayField(models.IntegerField(), size=7,null=False,default=default_working_days)
    not_working_dates = ArrayField(models.DateField(auto_now_add=True),null=True)
    def __str__(self):
        return self.name
